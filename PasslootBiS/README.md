...
A new list's rules land at the **top** of the rule list with **Before Advisor**
ticked, so your BiS picks are matched before any catch-all rule and before the
roll advisor gets a say. Move them with Up/Down or untick the box if you would
rather they didn't. Re-importing a list you already have, or re-applying a tick
selection from the BiS Manager, rebuilds those rules where they stand and leaves
both choices alone.
