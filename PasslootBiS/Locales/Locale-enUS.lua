...
-- Proficiencies panel (Modules/Proficiency.lua + Core "Proficiencies" options)
L["Proficiencies"] = true
L["Prof_Intro"] =
	"Reads what this character can actually equip, then writes the GAPS as auto-roll " ..
	"rules \226\128\148 so you stop rolling on armor and weapons you can't use.\n\n" ..
	"Two rules are generated: \"Proficiency: unusable armor\" and \"Proficiency: unusable " ..
	"weapons\". They are ordinary rules \226\128\148 edit them in the Rules list, move them " ..
	"with Up/Down, or delete them. Generating again overwrites them in place rather than " ..
	"adding duplicates. New rules go to the BOTTOM of the list, so a catch-all rule above " ..
	"them still wins."
L["Prof_NotLoaded"] = "Proficiency module not loaded."
L["Prof_Detected"] = "Detected proficiencies"
L["Prof_Rescan"] = "Rescan"
L["Prof_RescanDesc"] = "Read this character's proficiencies again (do this after training a new one)."
L["Prof_Action"] = "Roll action"
L["Prof_ActionDesc"] =
	"What to do with an item you have no proficiency for. Pass is the safe default; " ..
	"Greed/Disenchant still take the item off the table for you."
L["Prof_Armor"] = "Armor rule"
L["Prof_ArmorDesc"] =
	"Generate the rule for armor types you can't wear (Cloth / Leather / Mail / Plate / " ..
	"Shields). Cloaks, shirts and tabards are exempt \226\128\148 they are item subclass " ..
	"Cloth but need no proficiency."
L["Prof_Weapons"] = "Weapon rule"
L["Prof_WeaponsDesc"] = "Generate the rule for weapon types you have no proficiency for."
L["Prof_Generate"] = "Generate rules"
L["Prof_GenerateDesc"] = "Write (or overwrite) the generated rules from the detection above."
L["Prof_Remove"] = "Remove generated rules"
L["Prof_RemoveDesc"] = "Delete both generated rules. Your other rules are untouched."
-- %d = rules written, %s = roll action.
L["Prof_Done"] = "Wrote %d rule(s), rolling %s on gear you can't use."
L["Prof_Removed"] = "Removed %d generated rule(s)."
L["Prof_NoneRemoved"] = "No generated rules to remove."
L["Prof_NothingBuilt"] = "Nothing generated."
L["Prof_NoModule"] =
	"The \"Type / SubType\" module is switched off, so these rules can't match anything. " ..
	"Enable it on the Modules page first."
L["Prof_DetectFailed"] =
	"Could not read this character's proficiencies (%s), so no rules were generated. " ..
	"Run |cffffd100/plbisprof|r for the full probe output."
L["Prof_Known"] = "Can use"
L["Prof_Missing"] = "Cannot use"
L["Prof_Source"] = "Read from: %s"
L["Prof_Caveat"] =
	"Sanity-check the list above before generating \226\128\148 on Ascension you can train " ..
	"new proficiencies at any time, so rescan after you do."
