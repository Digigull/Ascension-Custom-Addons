# Auctionator — request backlog, 2026-08 (CLOSED)

> **Closed 2026-08-21.** Historical record of items 1-34. Superseded, and not to be read
...
- **The dump instructions were rewritten in this same commit**, which was the stated condition for
  creating the folder at all — this file and `tools/README.md` now name both files and both stock
