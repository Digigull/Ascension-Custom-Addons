...
- **There is no test suite, but there ARE offline tests — run the ones that cover what you
  ...
  All ten pass as of 2026-08. Non-shipped tooling lives in `management/addons/<addon>/tools/`;
