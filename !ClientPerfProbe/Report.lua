...
function Report.classify(spike)
    ...
    -- (docs/DRAG-FREEZE.md): a hand-rolled window pairing SetToplevel(true) with a populated
...
function Report.explain(spike)
    ...
    elseif code == "DRAG" then
        return "You were holding the mouse button as this froze — the long-standing 'window drag lag'. "
            ...
            .. "(A held button could also be a camera turn, but the window-drag freeze is by far the common case here.) See docs/DRAG-FREEZE.md for the measurement and the two-line fix."
    end
